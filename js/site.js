(function() {
'use strict';
var Site = angular.module('Site', ['ngRoute', 'ui.bootstrap', 'ngSanitize', 'weather_app', 'yelp_app', 'astro_app', 'movie_app','news_app', 'quote_app', 'time_app', 'mycity-directives', 'events_app', 'map_app', 'places_app', 'twitter_app', 'ngTouch', 'meetup_app', 'rates_app']);
